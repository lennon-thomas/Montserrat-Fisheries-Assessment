...
for (i in 1:nrow(dataInput))
{
    ...
    masterOutput$management[masterOutput$management == 1] = "BAU"
    masterOutput$management[masterOutput$management == 2] = "30% MPA"
    ...
    recoveryOutput$management[recoveryOutput$management == 1] = "BAU"
    recoveryOutput$management[recoveryOutput$management == 2] = "30% MPA"
   ...
   #  recoveryOutput$management[recoveryOutput$management == 5] = "close"
    ...
    npvOutput$management[npvOutput$management == 1] = "BAU"
    npvOutput$management[npvOutput$management == 2] = "30& MPA"
...
masterOutput<-masterOutput %>%
  filter(catchShare == "no_CS",
         illegalFishing == "no_illegal_fishing") %>%
  select(species,management,time,biomass,harvest1,profit1,BvBMSY,FvFMSY1,FvFMSYtotal)

write.csv(masterOutput,file="revenue_loss_scenarios/masterOutput.csv") 


recoveryOutput$implementYear = (recoveryOutput$implementYear + 1)
write.csv(recoveryOutput,file="revenue_loss_scenarios/workshop_0613_recovery_opt.csv")

npvOutput$implementYear = (npvOutput$implementYear + 1)
write.csv(npvOutput,file="NPV_results.csv") 
